...
public class RequestRepositoryTests {
	...
	public void getByIdTest() {
		...
		assertThat(request.getSubject()).isEqualTo("Novo Laptop HP Alterei");
	}
	...
	public void updateStatusTest() {
		int affectdRows = requestRepository.updateStatus(1L, RequestState.IN_PROGRESS);
		
		assertThat(affectdRows).isEqualTo(1);
	}
